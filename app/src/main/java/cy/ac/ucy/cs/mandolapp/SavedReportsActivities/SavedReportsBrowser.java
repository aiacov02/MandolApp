...
import cy.ac.ucy.cs.mandolapp.adapters.DropDownListAdapterSRBrowser;
import cy.ac.ucy.cs.mandolapp.adapters.DropDownListAdapterSRBrowserAuth;
 ...
 */
public class SavedReportsBrowser extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savedreports_browser);
        ...
        if(this.report.getCategories()!=null){
            ...
            Button btn = (Button)findViewById(R.id.sprCategoryBrowser);
        ...
        if(this.report.getAuthorities()!=null){
            ...
            Button btn = (Button)findViewById(R.id.sprAuthorityBrowser);
        ...
        TextView txtDate = (TextView)findViewById(R.id.txtDateBrowser);
        ...
        Button btnDelete = (Button)findViewById(R.id.btnDeleteBrowser);
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    DB.close();
                    Toast.makeText(my,"Report Deleted",Toast.LENGTH_LONG);
                    onBackPressed();
                }catch (Exception e){
                    e.printStackTrace();
                }
...
//        pw.showAsDropDown(layout1, 0, 0, Gravity.CENTER);
        ...
        if(isAboutCategory){
            DropDownListAdapterSRBrowser adapter = new DropDownListAdapterSRBrowser(my, items, btn);

            list.setAdapter(adapter);
        }
        else{
            DropDownListAdapterSRBrowserAuth adapter = new DropDownListAdapterSRBrowserAuth(my, items, btn);
            list.setAdapter(adapter);
        }
...
//        menu.findItem(R.id.action_websearch).setVisible(!drawerOpen);
    ...
    private boolean ReportNow() {
        ...
        Report reportToSend = new Report("browser",this.Url,description,CategoriesArray,AuthoritiesArray,this.report.getDate());
