...
public class HelpInternetBrowser extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitle.setText("Internet Browser");

        TextView txtIntro = (TextView)findViewById(R.id.txtDescription);

        txtIntro.setText(R.string.BrowserInstructions);
