package cy.ac.ucy.cs.mandolapp.AboutActivities;
...
public class About extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWebsite.setText("Visit Project Website");


        TextView txtCopyright = (TextView)findViewById(R.id.txtCopyright);
        txtCopyright.setText("Copyright © 2018 University of Cyprus ");

        btnWebsite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "http://mandola-project.eu/";
