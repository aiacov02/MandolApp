 ...
 */
public class ReportHistoryFacebook extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporthistory_facebook);
        ...
        TextView txtDescription = (TextView) findViewById(R.id.txtDescriptionFacebook);
        ...
        Button btnClear = (Button)findViewById(R.id.btnDeleteFacebook);
