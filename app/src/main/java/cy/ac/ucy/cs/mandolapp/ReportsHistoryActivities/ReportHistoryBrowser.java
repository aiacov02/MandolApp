 ...
 */
public class ReportHistoryBrowser extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporthistory_browser);
        ...
        TextView txtDescription = (TextView) findViewById(R.id.txtDescriptionBrowser);
        ...
        Button btnClear = (Button)findViewById(R.id.btnDeleteBrowser);
