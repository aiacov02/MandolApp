 ...
 */
public class ReportBrowserFirst extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    public static AsyncTask CheckAppTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_browser_first);
...
//        CheckAppTask = new CheckAppListener().execute("HELLO");
        ...
        this.listener = new ClipboardManager.OnPrimaryClipChangedListener() {
            ...
            public void onPrimaryClipChanged() {
                ...
                try{
                    ...
                    if(isValidURL(str2)){
                        Intent intent = new Intent(my,ReportBrowser.class);
                        intent.putExtra("Url", str2);
                        miniApp.setContentIntent(intent);
                        miniApp.notificationText = "Browser link copied";
    ...
    protected void onDestroy() {
        if(CheckAppTask!=null){
            CheckAppTask.cancel(true);
            CheckAppTask = null;
        }
...
//                System.err.println("ReportBrowserFirst");
...
//                    }
//                    else{
//                        if(!(currentApp.equals("com.example.myapp") || currentApp.equals("com.android.chrome") || currentApp.equals("com.android.browser") || currentApp.equals("org.mozilla.firefox") || currentApp.equals("com.opera.browser") || currentApp.equals("com.UCMobile.intl") || currentApp.equals("com.android.systemui"))){
//                            return "else";
//                        }
//                    }
//
...
//                miniApp.setContentIntent(intent);
//                miniApp.notificationText="Twitter app opened";
//                miniApp.notificationBadgeNumber=1;
//                tooleap.updateMiniAppAndNotify(appId,miniApp);
//                tooleap.showMiniApp(appId);
//                ((Activity)my).finish();
...
//                Intent intent = new Intent(my,ReportTwitterFirst.class);
//                miniApp.setContentIntent(intent);
//                miniApp.notificationText="Facebook app opened";
//                miniApp.notificationBadgeNumber=1;
//                tooleap.updateMiniAppAndNotify(appId,miniApp);
//                tooleap.showMiniApp(appId);
//                ((Activity)my).finish();
