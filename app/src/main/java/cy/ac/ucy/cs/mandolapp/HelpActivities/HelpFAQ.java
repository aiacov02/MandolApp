...
public class HelpFAQ extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<String> items_cat = Arrays.asList(getResources().getStringArray(R.array.FAQ_array));
