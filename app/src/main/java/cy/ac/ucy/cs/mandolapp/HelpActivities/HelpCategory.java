...
public class HelpCategory extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<String> items_cat = Arrays.asList(getResources().getStringArray(R.array.category_explanation));
        final ArrayList<String> Categories = new ArrayList<String>(items_cat);

        LinearLayout l1 = (LinearLayout) findViewById(R.id.l1);

        TextView txtIntro = (TextView)findViewById(R.id.txtTitle);

        txtIntro.setText("Below you will find information about what each category of hate speech refers to:");



        for(String cat: Categories){
            TextView textView = new TextView(my);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            params.setMargins(5,15,5,0);
            textView.setLayoutParams(params);
            textView.setText(cat);
            l1.addView(textView);
            View divider = new View(my,null,R.style.Divider);
