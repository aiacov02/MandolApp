...
public class HelpAuthorities extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtIntro.setText("Below you will find information about each of the authorities you can report to");
