 ...
 */
public class ReportHistoryTwitter extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reporthistory_twitter);
        ...
        TweetUtils.loadTweet(tweetId, new Callback<Tweet>() {
            ...
            public void success(Result<Tweet> result) {
                ...
                CompactTweetView tweetView = new CompactTweetView(ReportHistoryTwitter.this, tweet);
        ...
        TextView txtDescription = (TextView) findViewById(R.id.txtDescriptionTwitter);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    DB.close();
                    Toast.makeText(my,"Report Cleared",Toast.LENGTH_LONG);
                    onBackPressed();
                }catch (Exception e){
                    e.printStackTrace();
                }
