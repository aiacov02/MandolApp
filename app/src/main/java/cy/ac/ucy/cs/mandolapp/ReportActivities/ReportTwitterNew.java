 ...
 */
public class ReportTwitterNew extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_twitter_new);
        ...
        TweetUtils.loadTweet(tweetId, new Callback<Tweet>() {
            ...
            public void success(Result<Tweet> result) {
                ...
                CompactTweetView tweetView = new CompactTweetView(ReportTwitterNew.this, tweet);
        ...
        DropDownListAdapterAuth.selectedCount=0;
...
//        menu.findItem(R.id.action_websearch).setVisible(!drawerOpen);
    ...
    private boolean saveReport() {
        ...
        try{
            ...
            Report report = new Report("twitter",this.Url,description,CategoriesArray,AuthoritiesArray);
    ...
    private boolean ReportNow() {
        ...
        Report reportToSend = new Report("twitter", this.Url, description, CategoriesArray, AuthoritiesArray);
