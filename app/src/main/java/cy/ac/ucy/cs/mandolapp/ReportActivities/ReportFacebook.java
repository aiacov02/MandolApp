 ...
 */
public class ReportFacebook extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DropDownListAdapterFacebook.selectedCount=0;
        DropDownListAdapterFacebookAuth.selectedCount=0;
        ...
        Button btnCancel = (Button)findViewById(R.id.btnCancelFacebook);
        ...
        Button btnSave = (Button)findViewById(R.id.btnSaveLaterFacebook);
...
//        pw.showAsDropDown(layout1, 0, 0, Gravity.CENTER);
        ...
        if(isAboutCategory){
            DropDownListAdapterFacebook adapter = new DropDownListAdapterFacebook(my, items, btn);
            list.setAdapter(adapter);
        }
        else{
            DropDownListAdapterFacebookAuth adapter = new DropDownListAdapterFacebookAuth(my, items, btn);
            list.setAdapter(adapter);
        }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(my,ReportFacebookFirst.class);
...
//        menu.findItem(R.id.action_websearch).setVisible(!drawerOpen);
    ...
    private boolean saveReport() {
        ...
        try{
            ...
            Report report = new Report("facebook",this.Url,description,CategoriesArray,AuthoritiesArray);
    ...
    private boolean ReportNow() {
        ...
        Report reportToSend = new Report("facebook", this.Url, description, CategoriesArray, AuthoritiesArray);
