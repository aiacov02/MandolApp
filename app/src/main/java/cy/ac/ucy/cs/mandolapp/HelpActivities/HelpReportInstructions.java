...
public class HelpReportInstructions extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_reportinstructions);
        ...
        btnTutorial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(my, IntroActivity.class);
        ...
        btnCategory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Clicked(HelpCategory.class);
            }
        });

        Button btnAuthority = (Button)findViewById(R.id.btnAuthority);
        btnAuthority.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Clicked(HelpAuthorities.class);
            }
        });
        ...
        btnFacebook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Clicked(HelpFacebook.class);
            }
        });

        Button btnBrowser = (Button)findViewById(R.id.btnInternetBrowser);
        btnBrowser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Clicked(HelpInternetBrowser.class);
            }
        });
    ...
    public void Clicked(Class<?> myclass){
        Intent intent = new Intent(my,myclass);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(my,Help.class);
        miniApp.setContentIntent(intent);
