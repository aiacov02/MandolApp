 ...
 */
public class CustomAdapterReportHistory extends ArrayAdapter<Report> implements View.OnClickListener{
    ...
    public CustomAdapterReportHistory(ArrayList<Report> data, Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(report.getApp().equals("facebook")){
            ...
            viewHolder.imgApp.setImageBitmap(DbBitmapUtility.getImage(report.getImage()));
        }
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ReportHistory reportHistory = (ReportHistory) mContext;
                    reportHistory.DeleteReport(report,position);
