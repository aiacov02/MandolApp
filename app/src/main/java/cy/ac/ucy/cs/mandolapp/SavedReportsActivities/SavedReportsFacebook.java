...
import cy.ac.ucy.cs.mandolapp.adapters.DropDownListAdapterFacebook;
import cy.ac.ucy.cs.mandolapp.adapters.DropDownListAdapterFacebookAuth;
 ...
 */
public class SavedReportsFacebook extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_savedreports_facebook);
        ...
        WebView webView = (WebView)findViewById(R.id.webviewFacebook);
        String webcode = "<html>\n" +
                "   <body>\n" +
                "      <div class=\"fb-post\" \n" +
                "      data-href=\"" + this.Url + "\"\n" +
        ...
        webView.setWebViewClient(new WebViewClient(){
            public void onPageFinished(WebView view, String url) {
                RelativeLayout relativeLayout = (RelativeLayout)findViewById(R.id.relativeLayoutReportFacebook);
                relativeLayout.setVisibility(View.VISIBLE);
            }
        });
        webView.loadDataWithBaseURL("https://www.facebook.com", webcode, "text/html","utf-8",null);
        ...
        if(this.report.getCategories()!=null){
            ...
            Button btn = (Button)findViewById(R.id.sprCategoryFacebook);
        ...
        if(this.report.getAuthorities()!=null){
            ...
            Button btn = (Button)findViewById(R.id.sprAuthorityFacebook);
        ...
        TextView txtDate = (TextView)findViewById(R.id.txtDateFacebook);
        txtDate.setText(this.report.getDate());

        //onClickListener to initiate the dropDown list
        Button createButton = (Button)findViewById(R.id.sprCategoryFacebook);
        ...
        //onClickListener to initiate the dropDown list
        Button chooseAuthButton = (Button)findViewById(R.id.sprAuthorityFacebook);
        ...
        Button btnCancel = (Button)findViewById(R.id.btnDeleteFacebook);
        ...
        Button btnReport = (Button)findViewById(R.id.btnReportFacebook);
    ...
    private void initiatePopUp(ArrayList<String> items, boolean isAboutCategory){
        ...
        if(isAboutCategory){
            ...
            layout1 = (LinearLayout)findViewById(R.id.linearLayoutCategoryFacebook);
        }
        else{
            layout1 = (LinearLayout)findViewById(R.id.linearLayoutAuthorityFacebook);
        }
...
//        pw.showAsDropDown(layout1, 0, 0, Gravity.CENTER);
        ...
        Button btn;
        if(isAboutCategory){
            btn = (Button)findViewById(R.id.sprCategoryFacebook);
        }
        else{
            btn = (Button)findViewById(R.id.sprAuthorityFacebook);
        }
        //populate the drop-down list
        final ListView list = (ListView) layout.findViewById(R.id.dropDownList);
        if(isAboutCategory){
            DropDownListAdapterSRFacebook adapter = new DropDownListAdapterSRFacebook(my, items, btn);
            list.setAdapter(adapter);
        }
        else{
            DropDownListAdapterSRFacebookAuth adapter = new DropDownListAdapterSRFacebookAuth(my, items, btn);
            list.setAdapter(adapter);
        }
...
//        menu.findItem(R.id.action_websearch).setVisible(!drawerOpen);
    ...
    private boolean ReportNow() {
        ...
        String description = ((EditText) findViewById(R.id.txtDescriptionFacebook)).getText().toString();
        ...
        Report reportToSend = new Report("facebook",this.Url,description,CategoriesArray,AuthoritiesArray,this.report.getDate());

        isReportClickable = false;
        RelativeLayout r = (RelativeLayout) findViewById(R.id.relativeLayoutReportFacebook);
