...
//        selectedCount=0;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(ReportTwitterNew.checkSelected[position])
    ...
    private void setText(int position1){
        if (!ReportTwitterNew.checkSelected[position1]) {
            ReportTwitterNew.checkSelected[position1] = true;
            selectedCount++;
        } else {
            ReportTwitterNew.checkSelected[position1] = false;
            selectedCount--;
        }
        ...
        if (selectedCount == 0) {
            ...
            for (int i = 0; i < ReportTwitterNew.checkSelected.length; i++) {
                if (ReportTwitterNew.checkSelected[i] == true) {
