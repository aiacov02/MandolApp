 ...
 */
public class ReportTwitterFirst extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_twitter_first);
        ...
        if(!isToggleChecked){
            pl.droidsonroids.gif.GifTextView gif = (pl.droidsonroids.gif.GifTextView)findViewById(R.id.gifviewTwitter);
            gif.setVisibility(View.GONE);
            TextView textView = (TextView)findViewById(R.id.txtTwitterFirst);
            textView.setText("Please copy the link of the tweet that you wish to report");
        }
                ...
                case 1:
                    if (resultCode == Activity.RESULT_OK) {
                        ...
                        try {
                            ...
                            ImageView img1 = (ImageView) findViewById(R.id.imgImage);
...
//                System.err.println("ReportTwitterFirst");
...
//                    }
//                    else{
//                        if(!(currentApp.equals("com.example.myapp") || currentApp.equals("com.twitter.android"))){
//                            return "else";
//                        }
//                    }
//
...
//                miniApp.setContentIntent(intent);
//                miniApp.notificationBadgeNumber=1;
//                miniApp.notificationText="Browser opened";
//                tooleap.updateMiniAppAndNotify(appId,miniApp);
//                tooleap.showMiniApp(appId);
//                ((Activity)my).finish();
//            }
