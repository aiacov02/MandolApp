...
public class HelpTwitter extends TooleapActivities.Activity implements PlanetAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtIntro.setText(R.string.TwitterInstructions);

        GifTextView gf = (GifTextView)findViewById(R.id.gifImage);

        gf.setBackgroundResource(R.drawable.t5);
