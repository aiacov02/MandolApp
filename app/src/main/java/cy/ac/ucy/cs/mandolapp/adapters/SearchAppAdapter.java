...
public class SearchAppAdapter extends BaseAdapter {
    ...
    public void setSelected(String selected) {
        SearchAppAdapter.selected = selected;
    }

    public SearchAppAdapter(Context context, ArrayList<String> items,
                            Button btn) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(ReportHistory.checkSelectedApp[position])
    ...
    private void setText(int position1){
        if (!ReportHistory.checkSelectedApp[position1]) {
            ReportHistory.checkSelectedApp[position1] = true;
            selectedCount++;
        } else {
            ReportHistory.checkSelectedApp[position1] = false;
            selectedCount--;
        }
